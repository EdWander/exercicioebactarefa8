                  ...
                  Quando eu digitar o <nome>, <sobrenome>, <nome_empresa>, <pais>, <endereco>, <cidade>, <cep>, <telefone>, <endereco_email>
                  ...
                  | Vania | Costa     | EBAC        | EUA    | Roosevelt, 800      | Chicago        | 75484    | +1 (547)858-7548 | vaniacosta         | Cadastro inválido, check as informações |
                  ...
                  | Pedro | Marco     | EBAC        |        | Gerstungen, 5       | Eisenach       | 25474    |                  | pedrom@ebac.com.br | Cadastro inválido, check as informações |
                  | Edna  | Garcia    |             | Brasil | Rua paula lemos, 85 | Rio de Janeiro | 24451574 | 21 99971-5448    | edna1@ebac.com.br  | Cadastro realizado com sucesso          |
